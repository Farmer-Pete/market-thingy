...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/jq-3.3.1/dt-1.10.23/cr-1.5.3/fh-3.1.8/rr-1.2.7/datatables.min.css"/>
    <title>
        Comparative analysis of ${metadata.symbols} :: Market Thingy
    </title>
    <script type="text/javascript" src="https://cdn.datatables.net/v/dt/jq-3.3.1/dt-1.10.23/cr-1.5.3/fh-3.1.8/rr-1.2.7/datatables.min.js"></script>
    ...
    <style type="text/css">
        ...
        .source.a span { color: orange; }
        .source.b span { color: purple; }
    </style>
</head>
<body>
  <header>
                              ...
                              <td>
                                  <%
                                    key = ResultKey(period=period,
                                                    symbol=symbol,
                                                    year=metadata.dates[-1].year,
                                                    quarter=metadata.dates[-1].quarter)
                                  %>
